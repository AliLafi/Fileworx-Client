...
namespace FileworxObjects.Mappers
{
    public class ContactMapper
    {
        ...
        {
            return new ContactDTO(contact.IsReadFile, contact.IsWriteFile, contact.SendFilePath, contact.ReceiveFilePath, contact.LastFileReceptionDate, contact.IsWriteFtp, contact.IsReadFtp, contact.SendFtpPath, contact.ReceiveFtpPath, contact.LastFtpReceptionDate,contact.Host,contact.Username,contact.Password, contact.ID, contact.LastModifier, contact.Creator, contact.Name, contact.Description, contact.Created, contact.ModifyDate);
        }
